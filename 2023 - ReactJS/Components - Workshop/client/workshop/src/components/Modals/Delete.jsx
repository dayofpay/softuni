            ...
            <div className="modal">
                <div className="confirm-container">
                    <header className="headers">
                        <h2 style={{color:'black'}}>Are you sure you want to delete this account?</h2>
                    ...
                    <div className="actions">
                        <div id="form-actions">
                            <button id="action-save" className="btn" type="submit" onClick={handleDelete}
                                disabled={isDeleting}>
                                Delete
                            </button>
                            {isDeleting &&
